...
class LinkedBinaryTree:
    ...
    def leaves_list(self):
        return list(self.subtree_leaves_list(self.root))

    def subtree_leaves_list(self, root):
        if root is None:
            return
        ...
        yield from self.subtree_leaves_list(root.left)
        yield from self.subtree_leaves_list(root.right)
    ...
    def breadth_first(self):
        ...
        line = []
        line.append(self.root)
        while (line.is_empty() == False):
            curr_node = line.pop(0)
            yield curr_node
            if (curr_node.left is not None):
                line.append(curr_node.left)
            if (curr_node.right is not None):
                line.append(curr_node.right)
